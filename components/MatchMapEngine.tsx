...
function FarmFacts({ player }: { player: MatchPlayerAnalysis }) {
  ...
  return <aside className="map-insight-panel is-wide">
    ...
    <div className="map-fact-grid farm-total-grid"><Metric label="Lane Creeps" value={data?.laneCreeps} icon="/assets/map-analysis/camp.png" /><Metric label="Neutral Creeps" value={data?.neutralCreeps} icon="/assets/map-analysis/camp.png" /><Metric label="Ancient Creeps" value={data?.ancientCreeps} icon="/assets/map-analysis/camp.png" /><Metric label="Stacks" value={data?.stackedCamps} icon="/assets/map-analysis/camp.png" /><Metric label="Estimated dead-time cost" value={data?.deathCost} /></div>
    <Note text={data?.note} />
  </aside>;
}
...
function ObjectiveView({ player }: { player: MatchPlayerAnalysis }) {
  ...
  return <section className="objective-facts-view">
    ...
    <div className="objective-summary"><Metric label="Tower DMG" value={data?.towerDamage} icon="/assets/map-analysis/towers.png" /><Metric label="Tower Events" value={data?.towerKills} icon="/assets/map-analysis/towers.png" /><Metric label="Barracks Events" value={data?.barracksKills} icon="/assets/map-analysis/towers.png" /><Metric label="Roshan Events" value={data?.roshanKills} icon="/assets/map-analysis/roshan.png" /></div>
...
function objectiveIcon(type: "tower" | "roshan" | "barracks" | "other") { return type === "roshan" ? "/assets/map-analysis/roshan.png" : type === "other" ? "/assets/map-analysis/tormentors.png" : "/assets/map-analysis/towers.png"; }
