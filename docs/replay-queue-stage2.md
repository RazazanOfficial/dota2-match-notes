...
> این سند مراحل تاریخی راه‌اندازی صف را شرح می‌دهد. رفتار جدید دریافت
> درخواستی و آرشیو در [راهنمای Replay درخواستی](replay-on-demand-archive.md)
> آمده است؛ توضیح کشف خودکار مچ، ورودی دستی `incoming` و نبود آرشیو در
> پایین دیگر جاری نیست. **دستور انتقال فایل دستی را اجرا نکنید.**
