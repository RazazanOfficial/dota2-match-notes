...
> این سند مراحل آزمایشی parser با Replay دستی را ثبت کرده است. در جریان
> فعلی سایت، فایل دستی به صف اضافه نمی‌شود؛ راهنمای
> [Replay درخواستی](replay-on-demand-archive.md) مبنای استقرار است.
